...
public class TestBSTMapExtra {
     ...
     *
     * Just checking that c is gone (perhaps incorrectly) assumes that remove is
     * BST-structure preserving.
     *
     * More exhaustive tests could be done to verify implementation of remove, but
     * that would require doing things like checking for inorder vs. preorder swaps,
    ...
    /*
     * Remove Test 3 Checks that remove works correctly on root nodes when the node
     * has only 1 or 0 children on either side.
     */
    @Test
